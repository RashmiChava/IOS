...
//  Chava_WordGuess
//
//  Created by Rashmi Chava on 3/31/22.
//
...
class ViewController: UIViewController {
    ...
    var words = [["TESLA", "Elon Musk"],
                 ["STEVEJOBS","Apple Founder"],
                 ["ROSES", "Symbol of Love"],
                 ["PVSINDHU", "Indian badminton Player"],
                 ["BRINJAL", "King of Vegetables in india"]]
            

    var images =  ["TESLA","STEVEJOBS","ROSES","PVSINDHU","BRINJAL","GIVEUP"]
